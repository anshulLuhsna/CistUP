...
// }
  ...
  const handleDetectObjects = async () => {
    ...
    try {
      ...
      setDetectedImage(`data:image/jpeg;base64,${response.data.image_base64}`);
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center  justify-between mx-auto p-4">
    ...
    <FontAwesomeIcon className='inline' icon={faSearch} />
        ...
        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Object Detector</span>
    </a>
